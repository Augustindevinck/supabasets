...
const Testimonial = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-base-100 shadow-lg ring-1 ring-gray-900/10 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div>
              <blockquote className="text-xl font-medium leading-8 text-base-content sm:text-2xl sm:leading-10">
                Having the payments setup with Stripe + user auth is a blessing.
                This will save me like a week of work for each new side project I
                spin up. I appreciate that is well documented, as well. 100% worth it!
              </blockquote>
