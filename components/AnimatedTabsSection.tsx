  ...
  const tabs = [
    {
      ...
      value: "feature1",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-6 sm:p-8 md:p-10 text-lg sm:text-2xl md:text-4xl font-bold text-white bg-gradient-blue-primary">
    ...
    },
    {
      ...
      value: "feature2",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-6 sm:p-8 md:p-10 text-lg sm:text-2xl md:text-4xl font-bold text-white bg-gradient-blue-secondary">
